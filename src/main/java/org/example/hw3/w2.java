...
import org.example.hw3.hw3_2.Items.Items2;
...
public class w2 {
        public static void main(String[] args) {
            ...
            Items2 item1 = new Items2("Манго", "Китай", 290.23, 329.99, 1);
            Items2 item2 = new Items2("Авокадо", "Бразилия", 200.99, 225.0, 3);
            Items2 item3 = new Items2("Масло", "Россия", 190.99, 180.0, 2);
            Items2 item4 = new Items2("Картофель", "Белорусия", 42.99, 1000.0, 1);
            Items2 item5 = new Items2("Хлеб", "Россия", 45.99, 400.0, 2);
            Items2 item6 = new Items2("Айран", "Россия", 20.99, 523.05, 1);
            Items2 item7 = new Items2("Устрицы королевские высший размер", "Тайланд", 490.23, 800.0, 1);
